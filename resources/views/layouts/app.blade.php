...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm py-4  px-4">
            <header class="flex items-center justify-between px-8 py-4">
                <a  href="#"><img  src="{{ asset('img/vote1.png') }}" alt="logo" style="max-height: 50px;"></a>
            ...
            <main class="container mx-auto max-w-custom flex">
                <div class="w-70 mr-5">
                    ...
                    Debitis consequatur officiis architecto quis similique velit suscipit eius voluptate officia, repudiandae perspiciatis maiores placeat.
                    Praesentium rem officia, asperiores minima totam, commodi mollitia vitae aliquid nisi deleniti ipsa autem quos alias corporis?
                </div>
                <div class="w-175">
